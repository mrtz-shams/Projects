                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0"
                    ...
                    <a class="dropdown-item preview-item">
                        <div class="preview-thumbnail">
                            <img src="back/assets/images/faces/face10.jpg" alt="image" class="img-sm profile-pic">
                        </div>
                    ...
                    <a class="dropdown-item preview-item">
                        <div class="preview-thumbnail">
                            <img src="back/assets/images/faces/face12.jpg" alt="image" class="img-sm profile-pic">
                        </div>
                        <div class="preview-item-content flex-grow py-2">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
                ...
                @if(auth()->check())
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                        ...
                        <div class="dropdown-header text-center">
                            <a href="{{route('admin.profile', Auth::user()->id)}}" class="btn btn-success" >پروفایل من <i class="dropdown-item-icon ti-dashboard"></i></a>
                ...
                @else
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                        <div class="dropdown-header text-center">
                        <img class="img-md rounded-circle" src="back/assets/images/faces/face8.jpg" alt="Profile image">
                            <a  href="{{route('register')}}" class="dropdown-item"> ثبت نام <span class="badge badge-pill badge-danger"></span><i
                                class="dropdown-item-icon ti-dashboard"></i></a>
                                <a href="{{route('login')}}" class="dropdown-item"> ورود <span class="badge badge-pill badge-danger"></span><i
                                class="dropdown-item-icon ti-dashboard"></i></a>
                        </div>
                    </div>
